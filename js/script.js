...
function checkPledgesLeft(pledge) {
  ...
  if (number === 0) {
    ...
    if (
      pledge.parentElement.nextElementSibling &&
      pledge.parentElement.nextElementSibling.classList.contains(
        "about__pledge-option__button"
      )
    ) {
    ...
    if (
      pledge.parentElement.parentElement.firstElementChild.classList.contains(
        "back-project-modal__form__option__input"
      )
    ) {
...
const bookmarkButton = document.querySelector(
  ".intro__text-block__buttons__button-two"
);
...
const pledgeOptions = document.querySelectorAll(
  ".back-project-modal__form__option__input"
);
const pledgeOptionsOuters = document.querySelectorAll(
  ".back-project-modal__form__option"
);
const pledgeOptionsInnersTwo = document.querySelectorAll(
  ".back-project-modal__form__option__inner-two"
);
...
const closeModalButton = document.querySelector(
  ".back-project-modal__close-icon"
);
...
const backThisProject = document.querySelectorAll(
  ".intro__text-block__buttons__button-one"
);
...
backThisProject.forEach((backThisProject) => {
    backThisProject.addEventListener("click", () => {
      let pledgeType = backThisProject.getAttribute("data-pledge");
      document.documentElement.scrollTo({
        top: 200,
        behavior: "smooth",
      });
